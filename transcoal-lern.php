...
<div class='wrap'>
	...
	<form name="LernEnrollment" id="LernEnrollment">
...
<br>
 <INPUT TYPE="button" name="btnsubmitlernenrollment" id="btnsubmitlernenrollment" value="Get Enrollment"><div id="messageareaenrollment" ></div>
 </form>
</div>
<?php
}
