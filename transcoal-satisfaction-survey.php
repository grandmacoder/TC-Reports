<?php
function add_satisfaction_survey_list(){
if(!current_user_can('manage_options')){
		wp_die(__('You do not have sufficient permissions to access this page.'));
	}
	global $wpdb;
	$satisfaction_survey_list = new SatisfactionSurveyListClass();
...
<INPUT TYPE="button" name="btn_submit_satisfactionsurvey" id="btn_submit_satisfactionsurvey" value="Download File"><div id="messageareasatisfactionsurvey" ></div>
 </form>
</div>
<?php
}
//START HELPER FUNCTION CLASS
class SatisfactionSurveyListClass{
		...
		global $wpdb;
		$course_list = $wpdb->get_results("select `id`, `name` from wp_wp_pro_quiz_master where `name` like '%Satisfaction%' order by `name`", OBJECT);
        return $course_list;
	}		
}//END CLASS
?>